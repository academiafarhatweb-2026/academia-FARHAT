  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="field">
        ...
        <select id="classInstrument" value={form.instrument} onChange={(e) => setField('instrument', e.target.value)}>
      ...
      <div className="field">
        ...
        <select id="classTeacher" value={form.teacher} onChange={(e) => setField('teacher', e.target.value)}>
      ...
      <div className="field">
        ...
        {form.slots.map((slot, i) => (
          <div key={i} className="flex-row" style={{ marginBottom: 6 }}>
            ...
            <input type="number" min="0" max="23" style={{ width: 70 }} value={slot.startHour} onChange={(e) => updateSlot(i, 'startHour', e.target.value)} />
            <span>a</span>
            <input type="number" min="0" max="23" style={{ width: 70 }} value={slot.endHour} onChange={(e) => updateSlot(i, 'endHour', e.target.value)} />
